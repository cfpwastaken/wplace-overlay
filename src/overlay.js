// ==UserScript==
// @name         Wplace Overlay
// @namespace    https://wplace.immerheim.de
// @version      v2.4
// @description  Overlay for Wplace
// @author       cfp (adjusted by Vrontis for vtuber use)
// @match        https://wplace.live/*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=wplace.live
// @license      GPL-3.0-or-later
// @updateURL    https://wplace.immerheim.de/extra/overlay.user.js
// @downloadURL  https://wplace.immerheim.de/extra/overlay.user.js
// @grant        GM_setValue
// @grant        GM_getValue
// @grant        unsafeWindow
// ==/UserScript==
// Vrontis' Changelog:
// Initial:
// - Host & subpath changed for vtuber stuff
// - Adjusted the UserScript section
//
// 2.1:
// - Added "symbol" mode
//
// 2.2:
// - Added symbols to palette selector
//
// 2.3:
// - Added persistence for settings
// - fixed bug where symbols would not properly load in selector
// - added changelog section (hi)
//
// 2.4:
// - added unsafeWindow to fix a tampermonkey bug (lmao)
...
const HOST = "wplace.immerheim.de";
const SUBPATH = "";
...
window.fetch = unsafeWindow.fetch = new Proxy(fetch, { apply: async (target, thisArg, argList) => {
    if(!argList[0]) {
    ...
    if (paintMenu) {
        symbolList.forEach((color) => {
            ...
            if (b) {
                ...
                colorImg.src = "https://immerheim.de/wplace/" + color + ".png";
